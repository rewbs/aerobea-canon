...
This directory contains documentation of major historical events that have shaped the world of the canon countries.
...
**1777**
- [1777 Aerobea September Coup](1777-aerobea-september-coup.md) (9 April - 4 September 1777)
...
- **Redtoipi Jerry Edward James Oiverttiure** - Last PM before 1967 coup
- **David Thorot** - Restored democracy in 1980
- **Loopioi Loiuson** - Led Iuyusoy through WWII

### From Moohfalanda
- **Kloto Mooson** - Led Moohfalanda through WWII

## Related Directories

- [Countries](../countries/README.md) - Browse nations involved in these events
- [Figures](../figures/README.md) - Explore biographies of key participants
- `relations/` - International treaties and diplomatic relations (to be developed)

## Contributing New Events

When adding new events, follow the template at `skills/world-building/references/event_template.md` and ensure:
- Dates align with country timelines and figure biographies
- Countries involved existed at the specified time
- Outcomes are reflected in country files
- Real-world correlations are historically plausible
